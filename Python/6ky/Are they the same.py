...
a or b might be nil or null or None or nothing (except in C++, COBOL, Crystal, D, Dart, Elixir, Fortran, F#, Haskell, Nim, OCaml, Pascal, Perl, PowerShell, Prolog, PureScript, R,
...
def comp(array1, array2):
    print("1:",array1,"2:",array2)
    if array1==None and array2!=None or array2==None and array1!=None:
        return False
    ...
    for elem in range(len(array2)):
        if array2[elem] in squares:
            count+=1
            squares.remove(array2[elem])
            pass
    if count==len(array1)==len(array2):
        return True
    else:
        return False